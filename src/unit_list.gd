...
static var creature_cards: Array[Creature] = [
	...
	Creature.new("Sablemoth", CardType.AIR, 20, 1, 1, 2, "res://logo.png"),
	...
	Creature.new("Haunt", CardType.AIR, 10, 2, 2, 4, "res://logo.png"),
	...
	Creature.new("Void Tyrant", CardType.AIR, 60, 7, 7, 9, "res://logo.png"),
